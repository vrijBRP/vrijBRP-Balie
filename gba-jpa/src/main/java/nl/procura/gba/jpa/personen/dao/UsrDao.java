...
public class UsrDao extends GenericDao {
  ...
  public static List<Usr> find() {
    return GbaJpa.getManager().createNamedQuery("Usr.findAll").getResultList();
  }

  public static List<Usr> findByName(String username) {
    if (emp(username)) {
  ...
  public static List<Usr> findByEmail(String email) {
  ...
  public static List<Object[]> findUsrProfiles() {
