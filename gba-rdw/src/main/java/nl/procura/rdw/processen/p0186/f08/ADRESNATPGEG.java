 ...
 *       &lt;all>
 *         &lt;element name="BEGIN-DAT-ADR" type="{}DATUM-EJMD" minOccurs="0"/>
 ...
 *         &lt;element name="LOC-REG-NP-DIA" type="{}ADRES-REGEL-DIA" minOccurs="0"/>
...
public class ADRESNATPGEG implements Serializable {
  ...
  @XmlElement(name = "BEGIN-DAT-ADR")
  private BigInteger begindatadr;
  ...
  public BigInteger getBegindatadr() {
    return this.begindatadr;
  }

  public void setBegindatadr(BigInteger begindatadr) {
    this.begindatadr = begindatadr;
  }
