 ...
 *       &lt;all>
 *         &lt;element name="BROMF-CERT-NR" type="{}BROMF-CERT-NR" minOccurs="0"/>
 *         &lt;element name="AFGIFTE-DAT-BC" type="{}DATUM-EJMD" minOccurs="0"/>
...
public class BROMFCERTGEG implements Serializable {
  ...
  @XmlElement(name = "AFGIFTE-DAT-BC")
  private BigInteger afgiftedatbc;
  ...
  public BigInteger getAfgiftedatbc() {
    return this.afgiftedatbc;
  }

  public void setAfgiftedatbc(BigInteger afgiftedatbc) {
    this.afgiftedatbc = afgiftedatbc;
  }
