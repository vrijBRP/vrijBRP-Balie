...
import nl.procura.rdw.processen.p0181.f01.RYBGEG;
import nl.procura.rdw.processen.p0181.f01.RYBONDERHOUD;

/**
 * Registreren ontvangst rijbewijs na ongeldigverklaring a.g.v. vorderingsprocedure
 */
public class P0181 extends RdwAanvraagMessage {

  public RYBONDERHOUD newF1(BigInteger rijbewijsNummer) {

    RYBONDERHOUD p0181f1 = new RYBONDERHOUD();
    RYBGEG rGeg = new RYBGEG();
    rGeg.setRybnr(rijbewijsNummer);
    p0181f1.setRybgeg(rGeg);
    setRequest(new Proces(RdwProces.P0181_F1, p0181f1));
