...
public class GbaWsCustomSessionLogger extends AbstractSessionLog {

  public static final String SQL_STATEMENT = "sql-statement";

  private static final Logger LOGGER = LoggerFactory.getLogger(GbaWsCustomSessionLogger.class.getName());
