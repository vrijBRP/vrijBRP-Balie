...
public class Buurt extends GemeentelijkeTabel {

  public Buurt() {
    super(GBATable.BUURT);
    setDiacrietVeld(Diacs.OBJ_2);
    setSql("select distinct x.cObj, x.obj, x.diac from Obj2 x where x.cObj > 0 order by x.obj");
  }
