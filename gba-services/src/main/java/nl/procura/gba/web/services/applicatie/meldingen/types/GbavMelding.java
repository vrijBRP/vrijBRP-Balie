...
public class GbavMelding extends ServiceMelding {

  private final GbaWsRestGbavAccount account;

  public GbavMelding(String id, GbaWsRestGbavAccount account, String melding) {
    setId(id);
    setAdminOnly(true);
    setCategory(SYSTEM);
    setSeverity(WARNING);
  ...
  public GbaWsRestGbavAccount getAccount() {
    return account;
  }
}
