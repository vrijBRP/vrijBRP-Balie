...
package nl.procura.gba.web.services.bs.erkenning.argumenten;

import nl.procura.gba.common.ZaakType;
import nl.procura.gba.web.services.bs.algemeen.persoon.DossierPersoon;
import nl.procura.gba.web.services.zaken.algemeen.ZaakArgumenten;

public class ErkenningArgumenten extends ZaakArgumenten {

  private DossierPersoon moeder = null;

  public ErkenningArgumenten() {
    setTypen(ZaakType.ERKENNING);
  }
