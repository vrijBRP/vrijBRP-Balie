...
public class VerhuisHoofdbewoner implements Serializable {

  private static final long serialVersionUID = 7539506260255407268L;
  ...
  public VerhuisHoofdbewoner(VerhuisAanvraag aanvraag) {
  ...
  public void setBurgerServiceNummer(BsnFieldValue bsn) {
    this.bsn = bsn;
    getAanvraag().setHoofdBsn(bsn.getStringValue());
  }
