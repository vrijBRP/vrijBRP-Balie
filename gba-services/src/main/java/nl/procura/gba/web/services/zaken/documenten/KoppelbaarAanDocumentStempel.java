...
public interface KoppelbaarAanDocumentStempel {

  boolean isGekoppeld(DocumentStempel stempel);

  void koppelActie(DocumentStempel stempel, KoppelActie koppelActie);
}
