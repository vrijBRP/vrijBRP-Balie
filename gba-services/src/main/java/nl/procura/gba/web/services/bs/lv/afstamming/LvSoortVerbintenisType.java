...
@Getter
public enum LvSoortVerbintenisType implements EnumWithCode<String> {
  ...
  LvSoortVerbintenisType(String code, String oms) {
    this.code = code;
    this.oms = oms;
  }

  public static LvSoortVerbintenisType get(String code) {
  ...
  public boolean is(LvSoortVerbintenisType... types) {
