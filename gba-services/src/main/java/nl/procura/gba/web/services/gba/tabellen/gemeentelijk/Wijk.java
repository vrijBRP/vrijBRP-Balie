...
public class Wijk extends GemeentelijkeTabel {

  public Wijk() {
    super(GBATable.WIJK);
    setDiacrietVeld(Diacs.OBJ_1);
    setSql("select distinct x.cObj, x.obj, x.diac from Obj1 x where x.cObj > 0 order by x.obj");
  }
