...
public class P1654ToAanvraag {

  private final static Logger LOGGER = LoggerFactory.getLogger(P1654ToAanvraag.class.getName());

  public static RijbewijsAanvraag get(P1654 proces, RijbewijsAanvraag aanvraag, BasePLExt pl,
      Services services) {
    ...
    // Specifieke gegevens voor p1654
