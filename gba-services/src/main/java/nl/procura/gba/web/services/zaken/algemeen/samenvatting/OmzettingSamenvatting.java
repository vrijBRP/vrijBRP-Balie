...
/**
 * Maakt samenvatting van gegevens over een specifieke aanvraag voor een omzetting / GPS
 */
public class OmzettingSamenvatting extends ZaakSamenvattingTemplate<DossierOmzetting> {

  public OmzettingSamenvatting(ZaakSamenvatting zaakSamenvatting, DossierOmzetting zaak) {
    super(zaakSamenvatting, zaak);
  }

  @Override
  public void addDeelzaken(DossierOmzetting zaak) {
  ...
  @Override
  public void addZaakItems(DossierOmzetting zaak) {
    addRubriek("Gegevens omzetting GPS in huwelijk");
  ...
  private String getDatumTijd(DossierOmzetting zaak) {
    return zaak.getDatumVerbintenis().getFormatDate() + " vanaf " + zaak.getTijdVerbintenis().getFormatTime(
        "HH:mm");
  }

  private String getGetuigen(DossierOmzetting zaak) {
  ...
  private StringBuilder getOpties(DossierOmzetting zaak) {
    StringBuilder opties = new StringBuilder();
    for (DossierOmzettingOptie opt : zaak.getOpties()) {
  ...
  private String getStatus(DossierOmzetting zaak) {
  ...
  private void setBijzonderheden(DossierOmzetting zaak) {
  ...
  private void setNaamgebruik(DossierOmzetting zaak) {
  ...
  private void setPlanning(DossierOmzetting zaak) {
  ...
  private void setVereisten(DossierOmzetting zaak) {
