...
public class ReisdocumentZaakArgumenten extends ZaakArgumenten {

  private String documentnummer = "";

  public ReisdocumentZaakArgumenten() {
  }

  public ReisdocumentZaakArgumenten(String documentnummer) {
