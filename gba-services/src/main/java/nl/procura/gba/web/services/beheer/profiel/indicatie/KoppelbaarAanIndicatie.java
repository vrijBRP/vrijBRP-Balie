...
public interface KoppelbaarAanIndicatie {

  boolean isGekoppeld(PlAantekeningIndicatie indicatie);

  void koppelActie(PlAantekeningIndicatie indicatie, KoppelActie koppelActie);
}
