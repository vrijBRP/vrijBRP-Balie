...
public class GemDeel extends GemeentelijkeTabel {

  public GemDeel() {
    super(GBATable.GEMEENTE_DEEL);
    setDiacrietVeld(Diacs.GEM_DEEL);
    setSql("select x.cGemDeel, x.gemDeel, x.diac from GemDeel x order by x.gemDeel");
  }
