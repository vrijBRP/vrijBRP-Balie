...
import static nl.procura.gba.web.services.beheer.link.PersonenLinkType.NIEUWE_GEBRUIKER;
...
public class NieuweGebruikerEmail extends TemplateEmail {

  public NieuweGebruikerEmail(EmailTemplate template, Services services, String applicationUrl,
    ...
    PersonenLink link = new PersonenLink(links.getRandomId(), NIEUWE_GEBRUIKER);
