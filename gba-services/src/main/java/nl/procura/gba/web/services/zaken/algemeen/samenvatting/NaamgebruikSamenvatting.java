 ...
 */
public class NaamgebruikSamenvatting extends ZaakSamenvattingTemplate<NaamgebruikAanvraag> {

  public NaamgebruikSamenvatting(ZaakSamenvatting zaakSamenvatting, NaamgebruikAanvraag zaak) {
    super(zaakSamenvatting, zaak);
  }

  @Override
  public void addDeelzaken(NaamgebruikAanvraag zaak) {
  ...
  @Override
  public void addZaakItems(NaamgebruikAanvraag zaak) {
    ZaakItemRubriek rubriek = addRubriek("Wijziging naamgebruik");
    FieldValue ng = zaak.getNaamgebruikType();
    rubriek.add("Keuze naamgebruik", "{0} ({1})", ng.getDescription(), ng.getValue());
  }
}
