...
public interface KoppelbaarAanZaakConfiguratie {

  boolean isGekoppeld(ZaakConfiguratie configuratie);

  void koppelActie(ZaakConfiguratie configuratie, KoppelActie koppelActie);
}
