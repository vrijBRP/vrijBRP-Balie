...
public enum RijbewijsSchorsingCode {

  SCHORSING("S", "Schorsing van de geldigheid"),
  ...
  RijbewijsSchorsingCode(String code, String oms) {

    setCode(code);
    setOms(oms);
  }

  public static RijbewijsSchorsingCode get(String code) {
    for (RijbewijsSchorsingCode var : values()) {
