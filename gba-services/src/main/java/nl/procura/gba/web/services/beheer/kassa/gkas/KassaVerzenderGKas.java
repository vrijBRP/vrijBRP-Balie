...
public class KassaVerzenderGKas {

  private KassaParameters parameters;

  public KassaVerzenderGKas(KassaParameters parameters) {
  ...
  public boolean verstuur(List<String> bestanden) {
    ...
    switch (getParameters().getType()) {
      case LOKAAL:
      default:
        return new KassaLokaal().verstuur(KassaLeverancierType.JCC, parameters, bestanden);

      case FTP:
        return new KassaFtpGkas().verstuur(parameters, bestanden);
    }
  }
}
