...
public interface KoppelbaarAanDocumentKenmerk {

  boolean isGekoppeld(DocumentKenmerk kenmerk);

  void koppelActie(DocumentKenmerk kenmerk, KoppelActie koppelActie);
}
