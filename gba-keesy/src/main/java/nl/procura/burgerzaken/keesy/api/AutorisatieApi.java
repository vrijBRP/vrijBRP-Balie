...
public class AutorisatieApi {

  private final ApiClient apiClient;

  public AutorisatieApi(ApiClient apiClient) {
    this.apiClient = apiClient;
  }

  public ApiResponse<GeefStartUrlResponse> geefStartUrl(GeefStartUrlRequest request) throws ApiException {
    ApiClient.Request<Object> apiRequest;
    String localVarPath = "/geefStartUrl";
    apiRequest = new ApiClient.Request<>(localVarPath);
    apiRequest.body(request);
    defaultHeaders(apiClient.config(), apiRequest);
    return apiClient.post(apiRequest, GeefStartUrlResponse.class);
  }
