...
public class BerichtenApi {

  private final ApiClient apiClient;

  public BerichtenApi(ApiClient apiClient) {
    this.apiClient = apiClient;
  }

  public ApiResponse<byte[]> downloadBerichtenoverzicht(DownloadBerichtenoverzichtRequest request) throws ApiException {
    ApiClient.Request<Object> apiRequest;
    String localVarPath = "/downloadBerichtenoverzicht";
