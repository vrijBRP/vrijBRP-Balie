...
@XmlType(propOrder = { "zaakId", "gegevens" })
public class GbaRestDocumentZaak {

  private String                       zaakId   = "";
  private List<GbaRestDocumentGegeven> gegevens = new ArrayList<>();

  public GbaRestDocumentZaak() {
  }

  public GbaRestDocumentZaak(String zaakId) {
    this.zaakId = zaakId;
  }
  ...
  @Transient
  public GbaRestDocumentZaak addGegeven(String naam, String waarde) {
