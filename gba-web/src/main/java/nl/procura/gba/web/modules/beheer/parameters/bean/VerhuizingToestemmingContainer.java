...
public class VerhuizingToestemmingContainer extends ZaakStatusParameterContainer {

  public VerhuizingToestemmingContainer() {
    super(Arrays.asList(OPGENOMEN, WACHTKAMER));
  }
}
