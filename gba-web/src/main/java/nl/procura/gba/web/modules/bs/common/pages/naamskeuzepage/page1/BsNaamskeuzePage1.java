...
package nl.procura.gba.web.modules.bs.common.pages.naamskeuzepage.page1;
...
public class BsNaamskeuzePage1 extends BsNaamskeuzePage {

  public BsNaamskeuzePage1(DossierGeboorte dossierGeboorte) {
  ...
  public void event(PageEvent event) {
    ...
    if (event.isEvent(InitPage.class)) {
      zoekNaamskeuzesMoeder();
    }
  }

  private void zoekNaamskeuzesMoeder() {
    NaamskeuzeArgumenten zaakArgumenten = new NaamskeuzeArgumenten();
    zaakArgumenten.setMoeder(getDossierGeboorte().getMoeder());
