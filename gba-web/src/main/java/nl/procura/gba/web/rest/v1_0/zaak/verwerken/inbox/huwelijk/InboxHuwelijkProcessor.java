...
import nl.procura.brp.inbox.soap.endpoints.v1.huwelijksplanner.reservering.vraag.*;
...
public class InboxHuwelijkProcessor extends CaseProcessor {

  public InboxHuwelijkProcessor(Services services) {
    super(services);
  }

  public CaseProcessingResult addReservering(InboxRecord inboxRecord) {
