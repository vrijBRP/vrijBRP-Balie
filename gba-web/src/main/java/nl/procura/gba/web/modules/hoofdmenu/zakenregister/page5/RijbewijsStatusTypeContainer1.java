...
public class RijbewijsStatusTypeContainer1 extends ArrayListContainer {

  public RijbewijsStatusTypeContainer1() {
    ...
    for (RijbewijsStatusType type : RijbewijsStatusType.values()) {
      ...
      boolean isMax = type.getCode() <= RijbewijsStatusType.RIJBEWIJS_UITGEREIKT.getCode();
