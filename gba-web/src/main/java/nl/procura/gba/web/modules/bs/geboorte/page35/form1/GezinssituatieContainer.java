...
public class GezinssituatieContainer extends GbaContainer {

  public GezinssituatieContainer() {
    addItems(BINNEN_HETERO_HUWELIJK, BINNEN_HOMO_HUWELIJK, BUITEN_HUWELIJK);
  }
}
