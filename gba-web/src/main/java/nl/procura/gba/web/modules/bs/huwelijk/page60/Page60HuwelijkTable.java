...
public class Page60HuwelijkTable extends GbaTable {

  private final List<HuwelijkNaamgebruik> list = new ArrayList<>();
  ...
  public void setRecords() {
    ...
    for (HuwelijkNaamgebruik n : list) {
  ...
  protected void add(HuwelijkNaamgebruik v) {
