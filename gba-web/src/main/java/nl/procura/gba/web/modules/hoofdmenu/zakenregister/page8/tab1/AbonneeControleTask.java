...
public class AbonneeControleTask implements VaadinTask {

  private final static Logger  LOGGER  = LoggerFactory.getLogger(AbonneeControleTask.class.getName());
  ...
  public AbonneeControleTask(GbaApplication application, Controles controles) {
  ...
  public List<VaadinTaskLogger> getLoggers() {
    ...
    loggers.add(new VaadinTaskLogger(AbonneeControleTask.class.getName(), Level.DEBUG));
    return loggers;
  }
