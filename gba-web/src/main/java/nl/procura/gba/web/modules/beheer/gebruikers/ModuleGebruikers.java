...
@ModuleAnnotation(url = "#beheer.gebruikers",
    caption = "Gebruikers")
public class ModuleGebruikers extends ModuleTemplate {

  public ModuleGebruikers() {
  }
  ...
  public void event(PageEvent event) {
    ...
    if (event.isEvent(InitPage.class)) {
      getPages().getNavigation().goToPage(Page1Gebruikers.class);
    }
  }
}
