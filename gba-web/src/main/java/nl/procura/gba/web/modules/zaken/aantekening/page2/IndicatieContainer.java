...
public class IndicatieContainer extends ArrayListContainer {
  ...
  public IndicatieContainer(GbaApplication application) {
    for (PlAantekeningIndicatie indicatie : application.getServices().getAantekeningService()
        .getToegestaneIndicaties()) {
      addItem(indicatie);
    }
  }
}
