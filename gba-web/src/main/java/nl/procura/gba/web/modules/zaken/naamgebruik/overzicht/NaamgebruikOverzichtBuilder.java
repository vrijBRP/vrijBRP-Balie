...
public class NaamgebruikOverzichtBuilder {

  public static void addTab(ZaakTabsheet tabsheet, NaamgebruikAanvraag zaak) {
    tabsheet.addTab(new NaamgebruikOverzichtLayout(zaak), "Naamgebruik");

    // Zaken DMS tab
    boolean isZakenDsmAan = isTru(tabsheet.getApplication().getParmValue(ParameterConstant.BSM_ZAKEN_DMS));
    boolean isZaakDmsAan = isTru(tabsheet.getApplication().getParmValue(ParameterConstant.ZAKEN_DMS_NAAMGEBRUIK));
