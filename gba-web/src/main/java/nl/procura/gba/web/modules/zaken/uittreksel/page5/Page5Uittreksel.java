...
public class Page5Uittreksel extends ZakenPage {
  ...
  private Page5UittrekselForm1  form1         = null;
  private Page5UittrekselTable1 table1        = null;

  public Page5Uittreksel(Adres adres) {

    super("Uittreksel: toevoegen persoon");
  ...
  public void event(PageEvent event) {
    ...
    if (event.isEvent(InitPage.class)) {
      ...
      form1 = new Page5UittrekselForm1(adres.getAdres());
      table1 = new Page5UittrekselTable1();
  ...
  public void onNextPage() {
    ...
    Page3Uittreksel page1Document = getNavigation().getPage(Page3Uittreksel.class);
  ...
  private void doSearch(boolean binnenAdres) {
    ...
    try {
      ...
      Page5UittrekselBean1 bean = form1.getBean();
