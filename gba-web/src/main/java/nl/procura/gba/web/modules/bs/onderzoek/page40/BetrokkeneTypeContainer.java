...
public class BetrokkeneTypeContainer extends GbaContainer {

  public BetrokkeneTypeContainer() {
    Arrays.stream(BetrokkeneType.values())
        .filter(e -> e.getCode() > BetrokkeneType.ONBEKEND.getCode())
