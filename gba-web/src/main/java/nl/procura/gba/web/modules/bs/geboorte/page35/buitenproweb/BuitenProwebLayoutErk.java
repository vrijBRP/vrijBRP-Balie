...
public class BuitenProwebLayoutErk extends VerticalLayout implements ClickListener {

  private final Button                buttonReset = new Button("Reset");
  private final Page35GeboorteFormErk form;

  public BuitenProwebLayoutErk(DossierGeboorte geboorte) {
