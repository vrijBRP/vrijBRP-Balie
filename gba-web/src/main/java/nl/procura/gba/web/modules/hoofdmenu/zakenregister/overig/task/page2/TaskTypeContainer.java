...
public class TaskTypeContainer extends EnumContainer {

  public TaskTypeContainer() {
    super(TaskType.values());
  }

  public TaskTypeContainer(TaskEventType type) {
    super(Arrays.stream(TaskType.values()).filter(t -> t.getEventType() == type).collect(Collectors.toList()));
  }
}
