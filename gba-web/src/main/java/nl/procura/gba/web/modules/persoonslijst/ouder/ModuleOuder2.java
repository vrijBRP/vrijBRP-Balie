...
@ModuleAnnotation(url = "#pl.ouder2",
    caption = "Ouder 2",
    profielActie = ProfielActie.SELECT_PL_OUDERS)
public class ModuleOuder2 extends ModuleTemplate {
  ...
  public void event(PageEvent event) {
    ...
    if (event.isEvent(InitPage.class)) {
      BasePLSet set = getPl().getCat(GBACat.OUDER_2).getSets().get(0);
      PLOuderPage page = new PLOuderPage("Ouder 2", set);
