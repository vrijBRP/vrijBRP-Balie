...
public class Page2HuwelijkBean implements Serializable {
  ...
  public static final String REDENONTBINDING = "redenOntbinding";
  ...
  @Field(type = FieldType.TEXT_FIELD,
      caption = "Verbintenis")
  private String huwelijk = "";

  @Field(type = FieldType.TEXT_FIELD,
      caption = "Ontbinding")
  private String ontbinding = "";

  @Field(type = FieldType.TEXT_FIELD,
      caption = "Reden ontbinding")
  private String redenOntbinding = "";
}
