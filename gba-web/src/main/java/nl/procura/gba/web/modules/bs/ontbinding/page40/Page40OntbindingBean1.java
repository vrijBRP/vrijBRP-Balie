...
@Data
public class Page40OntbindingBean1 implements Serializable {
  ...
  @Field(customTypeClass = GbaComboBox.class,
      caption = "Naam na ontbinding/einde verbintenis partner 1",
      width = "100px")
  ...
  @Field(customTypeClass = GbaComboBox.class,
      caption = "Naam na ontbinding/einde verbintenis partner 2",
      width = "100px")
  @Select(containerDataSource = AdelijkeTitelContainer.class)
  @FilteringMode(mode = Mode.FILTERINGMODE_STARTSWITH)
  ...
  public Page40OntbindingBean1() {
  }

  public Page40OntbindingBean1(DossierPersoon p1, DossierPersoon p2) {
