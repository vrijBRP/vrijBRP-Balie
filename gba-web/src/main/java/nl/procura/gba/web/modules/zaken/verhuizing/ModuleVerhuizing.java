...
@ModuleAnnotation(url = "#zaken.verhuizing",
    caption = "Verhuizingen",
    service = VerhuizingService.class,
    zaakTypes = ZaakType.VERHUIZING,
    profielActie = ProfielActie.SELECT_ZAAK_VERHUIZING)
public class ModuleVerhuizing extends ZakenModuleTemplate {

  public ModuleVerhuizing() {
    setMargin(false);
  }
  ...
  public void event(PageEvent event) {
    ...
    if (event.isEvent(InitPage.class)) {
      ...
      getPages().getNavigation().goToPage(Page1Verhuizing.class);
    }
  }
}
