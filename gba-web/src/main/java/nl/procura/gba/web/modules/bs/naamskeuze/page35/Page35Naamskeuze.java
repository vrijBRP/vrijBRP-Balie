...
package nl.procura.gba.web.modules.bs.naamskeuze.page35;
...
import nl.procura.gba.web.modules.bs.naamskeuze.overzicht.NaamskeuzeOverzichtLayout;
import nl.procura.vaadin.component.dialog.ModalWindow;
import nl.procura.vaadin.component.layout.page.pageEvents.InitPage;
import nl.procura.vaadin.component.layout.page.pageEvents.PageEvent;

public class Page35Naamskeuze extends BsPageNaamskeuze {

  public Page35Naamskeuze() {
    super("Naamskeuze - overzicht");
  }
  ...
  public void event(PageEvent event) {
    if (event.isEvent(InitPage.class)) {
      ...
      addComponent(new NaamskeuzeOverzichtLayout(getZaakDossier()));
    }
