...
public class SingleDisplayFormWindow extends GbaModalWindow {

  public SingleDisplayFormWindow(GbaForm form, String width, String caption, String title) {
  ...
  private static final class Page extends NormalPageTemplate {
    ...
    private Page(GbaForm form, String title) {
      ...
      buttonLayout.addComponent(h2, buttonLayout.getComponentIndex(buttonClose));
