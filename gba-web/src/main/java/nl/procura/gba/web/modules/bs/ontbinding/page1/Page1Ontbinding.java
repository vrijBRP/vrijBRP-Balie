...
package nl.procura.gba.web.modules.bs.ontbinding.page1;
 ...
 * Partner 1
 */
public class Page1Ontbinding extends BsContactpersoonPage<DossierOntbinding> {

  public Page1Ontbinding() {
    super("Ontbinding/einde huwelijk/GPS in gemeente - partner 1");
  }
