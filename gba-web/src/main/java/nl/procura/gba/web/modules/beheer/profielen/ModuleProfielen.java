...
@ModuleAnnotation(url = "#beheer.profielen",
    caption = "Profielen")
public class ModuleProfielen extends ModuleTemplate {

  public ModuleProfielen() {
    setMargin(false);
  }
  ...
  public void event(PageEvent event) {
    ...
    if (event.isEvent(InitPage.class)) {
      getPages().getNavigation().goToPage(Page1Profielen.class);
    }
  }
}
