...
public class Page5ErkenningTable1 extends GbaTable {

  private final DossierErkenning erkenning;

  public Page5ErkenningTable1(DossierErkenning erkenning) {
  ...
  private String getAkte(DossierPersoon persoon) {
    ...
    sb.append(astr(persoon.getGeboorteAkteNummer()));
    sb.append(" ");
    sb.append(trim("/ " + persoon.getGeboorteAkteBrpNummer()));
    sb.append(", ");
    sb.append(pos(persoon.getGeboorteAkteJaar()) ? persoon.getGeboorteAkteJaar() : "");
    sb.append(", ");
    sb.append(astr(persoon.getGeboorteAktePlaats()));
  ...
  private Embedded getCheckbox(DossierPersoon persoon) {
    ...
    if (exists(erkenning.getKinderen(), having(kindBsn, equalTo(persoonBsn)))) {
