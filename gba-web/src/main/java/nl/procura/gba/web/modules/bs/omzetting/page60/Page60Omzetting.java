...
import static nl.procura.gba.web.modules.bs.omzetting.page60.Page60OmzettingBean1.*;
...
public class Page60Omzetting extends BsPage<DossierOmzetting> {

  private Page60OmzettingForm1 form1  = null;
  private Page60OmzettingTable table1 = null;

  public Page60Omzetting() {

    super("Omzetting GPS in huwelijk - naam(gebruik)");
  ...
  public boolean checkPage() {
    ...
    int i = 0;
    for (OmzettingNaamgebruik ng : table1.getAllValues(OmzettingNaamgebruik.class)) {
  ...
  public void event(PageEvent event) {
    ...
    try {
      ...
      if (event.isEvent(InitPage.class)) {
        ...
        DossierOmzetting zd = getZaakDossier();
        DossierPersoon p1 = zd.getPartner1();
        DossierPersoon p2 = zd.getPartner2();

        Page60OmzettingBean1 bean = new Page60OmzettingBean1(p1, p2);
        ...
        addComponent(form1);
        addComponent(new Fieldset("Naamgebruik na omzetting verbintenis", table1));
      }
    } finally {
      super.event(event);
    }
  ...
  public class Form1 extends Page60OmzettingForm1 {

    private Form1(Page60OmzettingBean1 bean) {
    ...
    public void init() {
      ...
      setCaption("Naam na omzetting verbintenis");
  ...
  public class Table1 extends Page60OmzettingTable {
    ...
    public void set() {
      ...
      OmzettingNaamgebruik n1 = new OmzettingNaamgebruik();
      ...
      OmzettingNaamgebruik n2 = new OmzettingNaamgebruik();
