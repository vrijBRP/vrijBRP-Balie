...
public class Page60OmzettingTable extends GbaTable {

  private final List<OmzettingNaamgebruik> list = new ArrayList<>();
  ...
  public void setRecords() {
    ...
    for (OmzettingNaamgebruik n : list) {
  ...
  protected void add(OmzettingNaamgebruik v) {
