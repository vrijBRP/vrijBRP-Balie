...
import nl.procura.gba.web.modules.bs.erkenning.page5.akte.Page5ErkenningAktePageForm1.Page5ErkenningAkteBean1;
...
public class Page5ErkenningAktePageForm1 extends GbaForm<Page5ErkenningAkteBean1> {
  ...
  public Page5ErkenningAktePageForm1(DossierPersoon persoon) {
    ...
    Page5ErkenningAkteBean1 bean = new Page5ErkenningAkteBean1();
  ...
  @Override
  public Page5ErkenningAkteBean1 getNewBean() {
    return new Page5ErkenningAkteBean1();
  }

  @FormFieldFactoryBean(accessType = ElementType.FIELD)
  public class Page5ErkenningAkteBean1 implements Serializable {
