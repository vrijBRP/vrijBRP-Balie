...
public class CountryBox extends GbaComboBox {

  public CountryBox() {
    this(GbaTables.get(GBATable.LAND).get());
  }

  public CountryBox(List<TabelFieldValue> list) {
    setContainerDataSource(new IndexedContainer());
    list.forEach(this::addItem);
    DateReference.setDate(this, along(new ProcuraDate().getSystemDate()));
  }
