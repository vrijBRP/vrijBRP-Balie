...
package nl.procura.gba.web.modules.zaken.huwelijk;
...
import nl.procura.gba.web.modules.zaken.huwelijk.page1.Page1Huwelijk;
import nl.procura.gba.web.services.beheer.profiel.actie.ProfielActie;
import nl.procura.gba.web.services.bs.algemeen.DossierService;
import nl.procura.vaadin.component.layout.page.pageEvents.InitPage;
import nl.procura.vaadin.component.layout.page.pageEvents.PageEvent;

@ModuleAnnotation(url = "#zaken.huwelijk",
    caption = "Huwelijk / GPS",
    service = DossierService.class,
    zaakTypes = { HUWELIJK_GPS_GEMEENTE, OMZETTING_GPS, ONTBINDING_GEMEENTE },
    profielActie = ProfielActie.SELECT_ZAAK_HUWELIJKGPS)
public class ModuleHuwelijk extends ZakenModuleTemplate {
  ...
  public void event(PageEvent event) {
    ...
    if (event.isEvent(InitPage.class)) {
      getPages().getNavigation().goToPage(Page1Huwelijk.class);
    }
  }
}
