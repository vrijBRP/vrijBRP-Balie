...
public class Tab1RaasPage2Subpage4 extends Tab1RaasPage2Subpage {

  public Tab1RaasPage2Subpage4(PageLayout parentLayout, DocAanvraagDto aanvraag) {
  ...
  public class Form extends Tab1RaasPage2Form {
    ...
    protected void createFields() {
      setOrder(RDM_DOC, NR_NL_DOC, AUTORIT, D_GELD_END, LENGTE, NATIO, AAND_BIJZ_NL);
    }

    @Override
    public void setColumn(TableLayout.Column column, Field field, Property property) {

      if (property.is(NATIO)) {
        getLayout().addFieldset("Nationaliteit");
      }
