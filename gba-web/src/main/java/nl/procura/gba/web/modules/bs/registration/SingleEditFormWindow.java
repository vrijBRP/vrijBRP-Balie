...
public class SingleEditFormWindow extends GbaModalWindow {

  public SingleEditFormWindow(AbstractRegistrationForm form, String width, String caption, String title) {
  ...
  private static final class Page extends NormalPageTemplate {
    ...
    private final AbstractRegistrationForm form;

    private Page(AbstractRegistrationForm form, String title) {
      this.form = form;
