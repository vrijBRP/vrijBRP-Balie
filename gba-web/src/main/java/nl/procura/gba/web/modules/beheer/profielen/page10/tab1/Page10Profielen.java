...
public class Page10Profielen extends KoppelPage {

  private static final int INDEX_STATUS = 0;
  private Profiel          profiel      = null;
  private Page10Table      table        = null;

  private KoppelForm form = null;

  public Page10Profielen(Profiel profiel) {

    super("Tonen indicaties");
    setProfiel(profiel);
  }
  ...
  protected void allesKoppelActie(KoppelActie koppelActie) {
    ...
    new KoppelProcedure(table, koppelActie, "indicaties", true) {
      ...
      public void koppel(KoppelActie koppelActie, boolean wholeTable) {
        Page10Profielen.this.koppel(koppelActie, wholeTable);
      }
    };
  }
  ...
  private List<PlAantekeningIndicatie> getSelectedIndicaties(boolean wholeTable) {

    List<PlAantekeningIndicatie> l;

    if (wholeTable) {
      l = table.getAllValues(PlAantekeningIndicatie.class);
    } else {
      l = table.getSelectedValues(PlAantekeningIndicatie.class);
    }
  ...
  private void setTable() {
    ...
    table = new Page10Table(getProfiel()) {
