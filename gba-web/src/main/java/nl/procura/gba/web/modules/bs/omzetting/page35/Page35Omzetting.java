...
package nl.procura.gba.web.modules.bs.omzetting.page35;
 ...
 * Getuige
 */
public class Page35Omzetting extends BsPersoonPage<DossierOmzetting> {

  public Page35Omzetting(DossierPersoon dossierPersoon) {

    super("Omzetting GPS in huwelijk - ambtenaar");
