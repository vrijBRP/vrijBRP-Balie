...
public class Page1EmailPreviewsForm extends GbaForm<Page1EmailPreviewsBean> {

  public Page1EmailPreviewsForm() {

    setColumnWidths("100px", "");
    setReadonlyAsText(false);
    setOrder(SJABLOON, ONDERWERP);
    setBean(new Page1EmailPreviewsBean());
  }
}
