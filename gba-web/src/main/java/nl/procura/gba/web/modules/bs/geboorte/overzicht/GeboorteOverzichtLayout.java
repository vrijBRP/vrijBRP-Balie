...
public class GeboorteOverzichtLayout extends VerticalLayout {

  private final DossierGeboorte geboorte;

  public GeboorteOverzichtLayout(final DossierGeboorte geboorte) {
    ...
    Table2 table2 = new Table2(geboorte.getDossier());

    Page84GeboorteForm1 form1 = new Page84GeboorteForm1(geboorte) {
    ...
    Page84GeboorteForm1 form2 = new Page84GeboorteForm1(geboorte) {

      @Override
      public void setCaptionAndOrder() {

        setCaption("Moeder");
        setOrder(NAAM_MOEDER, GEBOREN_MOEDER, GEMEENTE_MOEDER);
      }
    };

    Page84GeboorteForm1 form3 = new Page84GeboorteForm1(geboorte) {

      @Override
      public void setCaptionAndOrder() {

        setCaption("Vader / duo-moeder");
        setOrder(NAAM_VADER, GEBOREN_VADER, GEMEENTE_VADER);
      }
    };

    Page84GeboorteForm1 form4 = new Page84GeboorteForm1(geboorte) {
    ...
    Page84GeboorteForm1 form5 = new Page84GeboorteForm1(geboorte) {
