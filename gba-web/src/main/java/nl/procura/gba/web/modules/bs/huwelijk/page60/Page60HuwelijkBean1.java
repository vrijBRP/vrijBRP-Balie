...
@Data
public class Page60HuwelijkBean1 implements Serializable {
  ...
  @Field(customTypeClass = GbaComboBox.class,
      caption = "Naam na sluiting partner 1",
      width = "100px")
  ...
  @Field(customTypeClass = GbaComboBox.class,
      caption = "Naam na sluiting partner 2",
      width = "100px")
  @Select(containerDataSource = AdelijkeTitelContainer.class)
  @FilteringMode(mode = Mode.FILTERINGMODE_STARTSWITH)
  ...
  public Page60HuwelijkBean1() {
  }

  public Page60HuwelijkBean1(DossierPersoon p1, DossierPersoon p2) {
