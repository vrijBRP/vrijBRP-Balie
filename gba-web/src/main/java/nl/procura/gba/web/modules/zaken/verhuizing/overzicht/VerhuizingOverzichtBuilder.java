...
public class VerhuizingOverzichtBuilder {

  public static void addTab(ZaakTabsheet tabsheet, VerhuizingOverzichtLayout overzichtLayout, VerhuisAanvraag zaak) {
    tabsheet.addTab(overzichtLayout, "Verhuizing");

    // Zaken DMS tab
    boolean isZakenDsmAan = isTru(tabsheet.getApplication().getParmValue(ParameterConstant.BSM_ZAKEN_DMS));
    boolean isZaakDmsAan = isTru(tabsheet.getApplication().getParmValue(ParameterConstant.ZAKEN_DMS_VERHUIZING));
