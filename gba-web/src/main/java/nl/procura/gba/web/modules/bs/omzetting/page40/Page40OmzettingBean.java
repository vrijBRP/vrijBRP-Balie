...
public class Page40OmzettingBean implements Serializable {

  public static final String GEMEENTEGETUIGEN = "gemeenteGetuigen";
  public static final String GERELATEERDEN    = "gerelateerden";

  @Field(caption = "Gemeente getuige(n)",
      customTypeClass = GbaNativeSelect.class)
  @Select(nullSelectionAllowed = false)
  @Immediate
  private FieldValue gemeenteGetuigen = new FieldValue("0", "Geen");

  @Field(caption = "Gerelateerde als getuige",
      customTypeClass = GbaNativeSelect.class)
  @Immediate
