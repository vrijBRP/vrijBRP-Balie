...
public class Page11Profielen extends ButtonPageTemplate {
  ...
  public Page11Profielen(Profiel profiel) {
    setProfiel(profiel);
  }
  ...
  public void event(PageEvent event) {
    ...
    try {
      if (event.isEvent(InitPage.class)) {
        ...
        parameterBean.setFieldValues(getServices().getParameterService().getAllParameters(), 0,
            getProfiel().getCProfile());
  ...
  public class Tree extends ParameterTree {
    ...
    private Tree(ParameterBean parameterBean) {
      super(parameterBean, null, profiel);
    }
