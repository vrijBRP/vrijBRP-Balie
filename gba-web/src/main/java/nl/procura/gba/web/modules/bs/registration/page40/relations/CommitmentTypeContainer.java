...
public class CommitmentTypeContainer extends GbaContainer {

  public CommitmentTypeContainer() {
    addItem(CommitmentType.MARRIAGE);
    addItem(CommitmentType.GPS);
    addItem(CommitmentType.UNKNOWN);
  }
}
