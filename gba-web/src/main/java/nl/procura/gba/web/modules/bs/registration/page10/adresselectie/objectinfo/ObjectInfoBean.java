...
public class ObjectInfoBean implements Serializable {
  ...
  @Field(type = FieldType.LABEL, caption = "Adres")
  private String adres = "";

  @Field(type = FieldType.LABEL, caption = "Woningsoort")
  private String woningsoort = "";

  @Field(type = FieldType.LABEL, caption = "Woningindicatie")
  private String woningindicatie = "";

  @Field(type = FieldType.LABEL, caption = "Adresindicatie")
  private String adresindicatie = "";

  @Field(type = FieldType.LABEL, caption = "PPD-code")
  private String ppdcode = "";

  @Field(type = FieldType.LABEL, caption = "Stemdistrict")
  private String stemdistrict = "";

  @Field(type = FieldType.LABEL, caption = "Pandcode")
  private String pandcode = "";

  @Field(type = FieldType.LABEL, caption = "Wijkcode")
  private String wijkcode = "";

  @Field(type = FieldType.LABEL, caption = "Buurtcode")
  private String buurtcode = "";

  @Field(type = FieldType.LABEL, caption = "Subbuurtcode")
  private String subbuurtcode = "";

  @Field(type = FieldType.LABEL, caption = "Datum ingang")
  private String datumIngang = "";

  @Field(type = FieldType.LABEL, caption = "Datum einde")
  private String datumEinde = "";

  @Field(type = FieldType.LABEL, caption = "Opmerking")
  private String opmerking = "";

  @Field(type = FieldType.LABEL, caption = "Openbare ruimte")
  private String openbareRuimte = "";

  @Field(type = FieldType.LABEL, caption = "Woonplaats")
  private String woonplaats = "";

  @Field(type = FieldType.LABEL, caption = "ID-verblijfplaats (AON)")
  private String aon = "";

  @Field(type = FieldType.LABEL, caption = "ID-nummeraand. (INA)")
  private String ina = "";

  public ObjectInfoBean() {
  }

  public ObjectInfoBean(final BaseWKExt wk) {

    final BaseWK bk = wk.getBasisWk();
  ...
  private String get(final BaseWKValue o) {
