...
package nl.procura.gba.web.modules.bs.geboorte;
...
@ModuleAnnotation(url = "#" + ZaakFragment.FR_GEBOORTE,
    caption = "Geboorte",
    profielActie = ProfielActie.SELECT_ZAAK_AFSTAMMING)
public class ModuleGeboorte extends BsModule {

  private Dossier dossier = null;

  public ModuleGeboorte() {
  }

  public ModuleGeboorte(Dossier dossier) {
  ...
  public void event(PageEvent event) {
    ...
    if (event.isEvent(InitPage.class)) {
      ...
      if (dossier == null) {
        dossier = (Dossier) getApplication().getServices().getGeboorteService().getNewZaak();
      }

      setProcessen(new GeboorteProcessen(dossier, getApplication()));
    }
