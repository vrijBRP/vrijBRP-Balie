...
public class InboxVoornemenProcessor extends CaseProcessor {

  public InboxVoornemenProcessor(Services services) {
    super(services);
  }

  public CaseProcessingResult addVoornemen(InboxRecord inboxRecord) {
