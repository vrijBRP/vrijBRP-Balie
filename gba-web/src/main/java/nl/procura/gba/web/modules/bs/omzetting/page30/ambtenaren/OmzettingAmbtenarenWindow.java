...
public class OmzettingAmbtenarenWindow extends GbaModalWindow {

  private final DossierPersoon dossierPersoon;
  private final AmbtenarenForm form1;

  public OmzettingAmbtenarenWindow(AmbtenarenForm form1, DossierPersoon dossierPersoon) {

    super("Omzetting ambtenaren (Druk op escape om te sluiten)", "900px");
  ...
  public class Module extends ModuleTemplate {
    ...
    public void event(PageEvent event) {
      ...
      if (event.isEvent(InitPage.class)) {
        ...
        getPages().getNavigation().goToPage(new OmzettingAmbtenarenPage(form1, dossierPersoon));
      }
    }
  }
}
