...
public class Page5NaamskeuzeAkteWindow extends GbaModalWindow {

  private final DossierPersoon  kind;
  private final Page5Naamskeuze page;

  public Page5NaamskeuzeAkteWindow(Page5Naamskeuze page, DossierPersoon kind) {
    super("De kinderen van " + kind.getNaam().getVoorv_gesl() + " (Druk op escape om te sluiten)", "900px");
    this.page = page;
    this.kind = kind;
  }
  ...
  public class Module extends ModuleTemplate {
    ...
    public void event(PageEvent event) {
      ...
      if (event.isEvent(InitPage.class)) {
        getPages().getNavigation().goToPage(new Page5NaamskeuzeAktePage(page, kind));
      }
    }
  }
}
