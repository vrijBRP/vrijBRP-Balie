...
import static nl.procura.gba.web.rest.v1_0.zaak.verwerken.riskanalysis.rules.RelocationFilters.byCountryCode;
 ...
 * Rule 3
 */
public class Rule3Processor extends AbstractRuleProcessor {

  public Rule3Processor() {
    super(RiskProfileRuleType.RULE_3);
  }
  ...
  public boolean process(DossierRiskAnalysis riskAnalysis,
    ...
    int countryCode = rule.getIntAttribute(Z.name());
    TabelFieldValue country = Container.LAND.get(countryCode);
    ...
    info("{0} keer verhuist in de laatste {1} dagen naar land {2}",
        filteredList.size(), String.valueOf(days), country);
