...
package nl.procura.gba.web.rest.v1_0.zaak.zoeken.terugmelding;
...
public class GbaRestTerugmeldingHandler extends GbaRestElementHandler {

  public GbaRestTerugmeldingHandler(Services services) {
    super(services);
  }
  ...
  public void convert(GbaRestElement gbaZaak, Zaak zaakParm) {
    ...
    TerugmeldingAanvraag zaak = (TerugmeldingAanvraag) zaakParm;
    GbaRestElement tmv = gbaZaak.add(TERUGMELDING);
