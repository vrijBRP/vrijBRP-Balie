...
public class LopendeZakenWindow extends GbaModalWindow {

  private final BasePLExt persoonslijst;

  public LopendeZakenWindow(BasePLExt persoonslijst) {

    super("Overzicht (Druk op escape om te sluiten)", "800px");
  ...
  public class Module extends ModuleTemplate {
    ...
    public void event(PageEvent event) {
      ...
      if (event.isEvent(InitPage.class)) {
        ...
        getPages().getNavigation().goToPage(new Page1LopendeZaken(persoonslijst));
      }
    }
  }
}
