...
import nl.procura.gba.web.rest.v1_0.klapper.zoeken.GbaRestKlapperZoekenHandler;
import nl.procura.proweb.rest.guice.annotations.AuthenticatieVereist;

@RequestScoped
@Path("v1.0/klapper")
@AuthenticatieVereist
public class GbaRestKlapperResources extends GbaRestServiceResource {

  @POST
  @Consumes({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
  @Produces({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
  @Path("/zoeken")
  public GbaRestKlapperAntwoord get(GbaRestKlapperVraag vraag) {
    return new GbaRestKlapperAntwoord(new GbaRestKlapperZoekenHandler(getServices()).getRestKlappers(vraag));
  }
}
