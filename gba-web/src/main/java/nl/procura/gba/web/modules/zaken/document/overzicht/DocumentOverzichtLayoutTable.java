...
package nl.procura.gba.web.modules.zaken.document.overzicht;
...
public class DocumentOverzichtLayoutTable extends GbaTable {

  private DocumentZaak aanvraag;

  public DocumentOverzichtLayoutTable(DocumentZaak aanvraag) {
    setAanvraag(aanvraag);
  }

  public DocumentZaak getAanvraag() {
    return aanvraag;
  }

  public void setAanvraag(DocumentZaak aanvraag) {
  ...
  public void setRecords() {
    ...
    try {
      ...
      for (DocumentZaakPersoon p : getAanvraag().getPersonen()) {
      ...
      BasePLExt plAangever = gbaws.findPL(getAanvraag().getAnummer(),
          getAanvraag().getBurgerServiceNummer());
