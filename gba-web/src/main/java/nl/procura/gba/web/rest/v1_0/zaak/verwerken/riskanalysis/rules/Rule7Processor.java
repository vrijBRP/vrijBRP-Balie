 ...
 * Rule 7
 */
public class Rule7Processor extends AbstractDistrictRuleProcessor {

  public Rule7Processor() {
    super(RiskProfileRuleType.RULE_7);
  }
  ...
  public boolean process(DossierRiskAnalysis riskAnalysis,
    ...
    return isDistrictMatch(relatedCase, rule, "wijk", Container.WIJK);
  }
}
