...
public class Page20NaturalisatieWindow extends GbaModalWindow {

  private final DossierPersoon      ouder;
  private final Page20Naturalisatie page;

  public Page20NaturalisatieWindow(Page20Naturalisatie page, DossierPersoon ouder) {
    super("De kinderen van " + ouder.getNaam().getVoorv_gesl() + " (Druk op escape om te sluiten)", "1200px");
    this.page = page;
    this.ouder = ouder;
  }
  ...
  public class Module extends ModuleTemplate {
    ...
    public void event(PageEvent event) {
      ...
      if (event.isEvent(InitPage.class)) {
        getPages().getNavigation().goToPage(new Page20NaturalisatieWindowPage(page, ouder));
      }
    }
  }
}
