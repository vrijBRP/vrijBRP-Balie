...
public class AanschrijvingFaseContainer extends GbaContainer {

  public AanschrijvingFaseContainer(DossierOnderzoek onderzoek) {
    for (AanschrijvingFaseType fase : onderzoek.getFases()) {
      addItem(fase);
    }
  }
}
