...
public class Page5ErkenningWindow extends GbaModalWindow {

  private final DossierPersoon ouder;
  private final Page5Erkenning page;

  public Page5ErkenningWindow(Page5Erkenning page, DossierPersoon ouder) {
  ...
  public class Module extends ModuleTemplate {
    ...
    public void event(PageEvent event) {
      ...
      if (event.isEvent(InitPage.class)) {
        getPages().getNavigation().goToPage(new Page5ErkenningWindowPage(page, ouder));
      }
    }
  }
}
