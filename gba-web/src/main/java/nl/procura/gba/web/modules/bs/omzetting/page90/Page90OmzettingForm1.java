...
import static nl.procura.gba.web.modules.bs.omzetting.page90.Page90OmzettingBean1.*;
...
public class Page90OmzettingForm1 extends GbaForm implements AmbtenarenForm {

  private final DossierOmzetting zaakDossier;

  public Page90OmzettingForm1(DossierOmzetting zaakDossier) {
  ...
  @Override
  public Page90OmzettingBean1 getBean() {
    return (Page90OmzettingBean1) super.getBean();
  }

  @Override
  public Object getNewBean() {
    return new Page90OmzettingBean1();
  }
  ...
  public void update() {
    ...
    Page90OmzettingBean1 bean = new Page90OmzettingBean1();
