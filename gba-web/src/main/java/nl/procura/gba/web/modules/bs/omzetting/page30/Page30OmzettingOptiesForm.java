...
public class Page30OmzettingOptiesForm extends Form {

  private final HashMap<DossierOmzettingOptie, AbstractField> map = new HashMap<>();
  private List<DossierOmzettingOptie>                         opties;

  public Page30OmzettingOptiesForm(List<DossierOmzettingOptie> opties) {
  ...
  public void commit() {
    ...
    for (Entry<DossierOmzettingOptie, AbstractField> entry : map.entrySet()) {
  ...
  public class Layout extends TableLayout {
    ...
    public Layout() {
      ...
      List<DossierOmzettingOptie> list = new ArrayList<>(opties);

      MiscUtils.sort(list);

      setColumnWidths("400px", "");

      for (DossierOmzettingOptie huwOpt : list) {
