...
public class StempasAanduidingContainer extends GbaContainer {

  public StempasAanduidingContainer() {
    Arrays.asList(StempasAanduidingType.values()).forEach(this::addItem);
  }
}
