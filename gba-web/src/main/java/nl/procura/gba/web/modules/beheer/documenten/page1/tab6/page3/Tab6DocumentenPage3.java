...
package nl.procura.gba.web.modules.beheer.documenten.page1.tab6.page3;
...
public class Tab6DocumentenPage3 extends NormalPageTemplate {

  private final BeheerTabsheet tabs = new BeheerTabsheet();

  private final List<DocumentRecord> docList;

  public Tab6DocumentenPage3(List<DocumentRecord> docList) {

    super("Stempel koppelen aan documenten");
  ...
  public void event(PageEvent event) {
    ...
    if (event.isEvent(InitPage.class)) {
      ...
      final SelectedDocsPage docTab = new SelectedDocsPage(docList, KoppelbaarAanDocumentType.STEMPEL);
      final KoppelStempelsAanDocumentenPage printoptieTab = new KoppelStempelsAanDocumentenPage(docList);
