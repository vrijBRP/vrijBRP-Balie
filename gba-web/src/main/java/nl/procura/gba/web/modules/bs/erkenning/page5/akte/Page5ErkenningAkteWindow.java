...
public class Page5ErkenningAkteWindow extends GbaModalWindow {

  private final DossierPersoon kind;
  private final Page5Erkenning page;

  public Page5ErkenningAkteWindow(Page5Erkenning page, DossierPersoon kind) {
  ...
  public class Module extends ModuleTemplate {
    ...
    public void event(PageEvent event) {
      ...
      if (event.isEvent(InitPage.class)) {
        getPages().getNavigation().goToPage(new Page5ErkenningAktePage(page, kind));
      }
    }
  }
}
