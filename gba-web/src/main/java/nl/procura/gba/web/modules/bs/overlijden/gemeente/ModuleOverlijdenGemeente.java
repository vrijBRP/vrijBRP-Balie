...
package nl.procura.gba.web.modules.bs.overlijden.gemeente;
...
@ModuleAnnotation(url = "#" + ZaakFragment.FR_OVERL_GEMEENTE,
    caption = "In gemeente",
    profielActie = ProfielActie.SELECT_ZAAK_OVERLIJDEN)
public class ModuleOverlijdenGemeente extends BsModule {

  private Dossier dossier = null;

  public ModuleOverlijdenGemeente() {
  }

  public ModuleOverlijdenGemeente(Dossier dossier) {
  ...
  public void event(PageEvent event) {
    ...
    if (event.isEvent(InitPage.class)) {
      ...
      if (dossier == null) {
        dossier = (Dossier) getApplication().getServices().getOverlijdenGemeenteService().getNewZaak();
      }
      ...
      setProcessen(new OverlijdenGemeenteProcessen(dossier, getApplication()));
    }
