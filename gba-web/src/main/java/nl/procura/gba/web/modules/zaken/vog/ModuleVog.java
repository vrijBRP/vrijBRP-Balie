...
@ModuleAnnotation(url = "#zaken.vog",
    caption = "VOG",
    zaakTypes = ZaakType.COVOG,
    service = VogsService.class,
    profielActie = ProfielActie.SELECT_ZAAK_VOG)
public class ModuleVog extends ZakenModuleTemplate {
  ...
  public void event(PageEvent event) {
    ...
    if (event.isEvent(InitPage.class)) {
      ...
      getPages().getNavigation().goToPage(Page1Vog.class);
    }
  }
}
