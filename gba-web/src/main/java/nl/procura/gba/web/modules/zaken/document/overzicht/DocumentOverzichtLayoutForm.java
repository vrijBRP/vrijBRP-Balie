...
public class DocumentOverzichtLayoutForm extends ReadOnlyForm {

  public DocumentOverzichtLayoutForm(DocumentZaak aanvraag) {
    setCaption(aanvraag.getDoc().getDocumentType().getOms());
    setOrder(DOCUMENT, AFNEMER, DOEL);
    setColumnWidths(WIDTH_130, "");

    DocumentOverzichtLayoutBean bean = new DocumentOverzichtLayoutBean();
  ...
  @Override
  public DocumentOverzichtLayoutBean getBean() {
    return (DocumentOverzichtLayoutBean) super.getBean();
  }
}
