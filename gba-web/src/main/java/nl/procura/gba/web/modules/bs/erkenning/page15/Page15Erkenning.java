...
package nl.procura.gba.web.modules.bs.erkenning.page15;
...
public class Page15Erkenning extends BsContactpersoonPage<DossierErkenning> {

  public Page15Erkenning() {

    super("Erkenning - erkenner");
  }
  ...
  public void event(PageEvent event) {
    ...
    if (event.isEvent(InitPage.class)) {
      ...
      setDossierPersoon(getZaakDossier().getErkenner());

      getDossierPersoon().setDossierPersoonType(ERKENNER);
    }
