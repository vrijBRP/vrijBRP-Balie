...
import static nl.procura.gba.web.modules.bs.huwelijk.page60.Page60HuwelijkBean1.NATIOP1;
import static nl.procura.gba.web.modules.bs.huwelijk.page60.Page60HuwelijkBean1.NATIOP2;
...
public class Page60HuwelijkForm1 extends GbaForm<Page60HuwelijkBean1> {

  public Page60HuwelijkForm1(Page60HuwelijkBean1 bean) {
  ...
  @Override
  public Page60HuwelijkBean1 getNewBean() {
    return new Page60HuwelijkBean1();
  }
