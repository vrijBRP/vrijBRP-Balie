...
package nl.procura.gba.web.modules.bs.omzetting.page16;
...
public class Page16Omzetting extends BsPage<DossierOmzetting> {

  private RelatiesLayout relatiesLayout1 = null;
  private RelatiesLayout relatiesLayout2 = null;

  public Page16Omzetting() {
    super("Omzetting GPS in huwelijk - gerelateerden");
  ...
  public class RelatiesLayout extends PageBsGerelateerdeLayout {
    ...
    public RelatiesLayout(DossierPersoon dossierPersoon) {
      ...
      super(Page16Omzetting.this.getApplication(), getDossier(), dossierPersoon);
