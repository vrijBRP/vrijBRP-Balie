...
public class VertegenwoordigerQuickSearchTable extends GbaTable {

  private final PLResultComposite result;

  public VertegenwoordigerQuickSearchTable(PLResultComposite result) {
    this.result = result;
  }
