...
package nl.procura.gba.web.modules.beheer.documenten.page1.tab1.page3;
...
public class Tab1DocumentenPage3 extends NormalPageTemplate {

  private final BeheerTabsheet tabs = new BeheerTabsheet();

  private final List<DocumentRecord> docList;

  public Tab1DocumentenPage3(List<DocumentRecord> docList) {

    super("Printopties koppelen aan documenten");
  ...
  public void event(PageEvent event) {
    ...
    if (event.isEvent(InitPage.class)) {
      ...
      final SelectedDocsPage docTab = new SelectedDocsPage(docList, KoppelbaarAanDocumentType.PRINTOPTIE);
      final KoppelPrintoptiesAanDocumentenPage printoptieTab = new KoppelPrintoptiesAanDocumentenPage(docList);

      tabs.addTab("Geselecteerde documenten", (LazyTabChangeListener) () -> docTab);

      tabs.addTab("Printopties", (LazyTabChangeListener) () -> printoptieTab);
