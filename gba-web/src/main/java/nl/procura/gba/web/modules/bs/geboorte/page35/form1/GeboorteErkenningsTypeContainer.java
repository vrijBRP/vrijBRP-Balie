...
public class GeboorteErkenningsTypeContainer extends GbaContainer {

  public GeboorteErkenningsTypeContainer() {
    addItems(GEEN_ERKENNING, ERKENNING_ONGEBOREN_VRUCHT, ERKENNING_BIJ_AANGIFTE);
  }
}
