...
public class Page4ZakenProtocollering extends ZakenPage {

  public Page4ZakenProtocollering(ProtocolRecord protocolRecord, String categorie,
      List<ProtocolRecordAttribuut> list) {
