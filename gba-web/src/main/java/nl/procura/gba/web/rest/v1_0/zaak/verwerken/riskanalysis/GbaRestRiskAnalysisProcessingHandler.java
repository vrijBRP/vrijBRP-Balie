...
public class GbaRestRiskAnalysisProcessingHandler extends GbaRestZaakAlgemeenToevoegenHandler {

  public GbaRestRiskAnalysisProcessingHandler(Services services) {
    super(services);
  }

  public CaseProcessingResult process(Zaak zaak) {
    return new RiskAnalysisProcessor(getServices()).process(zaak);
  }
}
