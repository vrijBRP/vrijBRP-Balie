...
public class Page1Naamskeuze extends BsContactpersoonPage<DossierNaamskeuze> {

  public Page1Naamskeuze() {
    super("Naamskeuze - moeder uit wie het kind wordt / is geboren");
  }
