...
@ModuleAnnotation(url = "#zaken.verstrekbep",
    caption = "Verstrekkingsbeperking",
    zaakTypes = ZaakType.VERSTREKKINGSBEPERKING,
    service = VerstrekkingsBeperkingService.class,
    profielActie = ProfielActie.SELECT_ZAAK_VERSTREKKINGSBEPERKING)
public class ModuleGeheim extends ZakenModuleTemplate {
  ...
  public void event(PageEvent event) {
    ...
    if (event.isEvent(InitPage.class)) {
      getPages().getNavigation().goToPage(Page1Geheim.class);
    }
  }
}
