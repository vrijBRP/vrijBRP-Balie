...
public class OmzettingLocatiesPage extends ButtonPageTemplate {
  ...
  class Table1 extends GbaTable {
    ...
    public void setRecords() {
      ...
      List<HuwelijksLocatie> locaties = getServices().getOmzettingService().getHuwelijksLocaties(
