...
package nl.procura.gba.web.modules.bs.overlijden.gemeente.page50;
...
import nl.procura.gba.web.modules.bs.overlijden.gemeente.overzicht.OverlijdenGemeenteOverzichtLayout;
  ...
  public void event(PageEvent event) {
    ...
    try {
      if (event.isEvent(InitPage.class)) {
        ...
        addComponent(new OverlijdenGemeenteOverzichtLayout(getZaakDossier()));
      }
    } finally {
      super.event(event);
    }
