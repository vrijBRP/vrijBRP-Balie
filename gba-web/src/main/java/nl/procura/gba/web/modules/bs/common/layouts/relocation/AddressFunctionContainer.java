...
public class AddressFunctionContainer extends GbaContainer {

  public AddressFunctionContainer() {
    addItem(FunctieAdres.WOONADRES);
    addItem(FunctieAdres.BRIEFADRES);
  }
}
