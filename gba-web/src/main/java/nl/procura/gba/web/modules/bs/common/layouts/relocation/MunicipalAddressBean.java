...
public class MunicipalAddressBean {
  ...
  public static final String F_ADDRESS_FUNCTION = "addressFunction";
  ...
  @Field(customTypeClass = GbaNativeSelect.class,
      caption = "Functie",
      width = "100px")
  @Select(containerDataSource = AddressFunctionContainer.class,
      nullSelectionAllowed = false)
  @Immediate()
  private FunctieAdres addressFunction = FunctieAdres.WOONADRES;

  @Field(customTypeClass = ConsentProviderField.class,
      caption = "Toestemminggever",
      readOnly = true)
  private ConsentProvider consentProvider = ConsentProvider.notDeclared();

  @Field(customTypeClass = GbaNativeSelect.class,
      caption = "Aantal personen nieuw adres",
      width = "55px",
      validators = NumberOfPeopleValidator.class)
  @Select(containerDataSource = NumberOfPersonsContainer.class,
      nullSelectionAllowed = false)
  @Immediate
  private FieldValue noOfPeople;
