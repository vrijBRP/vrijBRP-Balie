...
package nl.procura.gba.web.modules.bs.lv.page50;
...
public class Page50Lv extends BsPage<DossierLv> {

  public Page50Lv() {
    super("Latere vermelding - overzicht");
  }
  ...
  public void event(PageEvent event) {
    try {
      if (event.isEvent(InitPage.class)) {
        ...
        addComponent(new LvOverzichtLayout(getZaakDossier()));
      }
    } finally {
      super.event(event);
    }
