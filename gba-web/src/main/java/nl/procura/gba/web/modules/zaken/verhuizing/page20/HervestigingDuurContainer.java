...
public class HervestigingDuurContainer extends GbaContainer {

  public HervestigingDuurContainer() {
    addItem(HervestigingDuur.LANGER);
    addItem(HervestigingDuur.KORTER);
  }
}
