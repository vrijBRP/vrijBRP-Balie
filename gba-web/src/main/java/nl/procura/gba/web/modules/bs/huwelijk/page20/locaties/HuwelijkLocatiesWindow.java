...
public class HuwelijkLocatiesWindow extends GbaModalWindow {

  private final Page20HuwelijkForm1 form;

  public HuwelijkLocatiesWindow(Page20HuwelijkForm1 form) {
    super("Huwelijk locaties (Druk op escape om te sluiten)", "900px");
    this.form = form;
  }
  ...
  public class Module extends ModuleTemplate {
    ...
    public void event(PageEvent event) {
      ...
      if (event.isEvent(InitPage.class)) {
        getPages().getNavigation().goToPage(new HuwelijkLocatiesPage(form));
      }
    }
  }
}
