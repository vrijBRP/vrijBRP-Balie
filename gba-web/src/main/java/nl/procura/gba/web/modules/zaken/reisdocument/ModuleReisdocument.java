...
@ModuleAnnotation(url = "#zaken.reisdocument",
    caption = "Reisdocumenten",
    zaakTypes = ZaakType.REISDOCUMENT,
    service = ReisdocumentService.class,
    profielActie = ProfielActie.SELECT_ZAAK_REISDOCUMENT)
public class ModuleReisdocument extends ZakenModuleTemplate {
  ...
  public void event(PageEvent event) {
    ...
    if (event.isEvent(InitPage.class)) {
      ...
      getPages().getNavigation().goToPage(Page1Reisdocument.class);
    }
  }
}
