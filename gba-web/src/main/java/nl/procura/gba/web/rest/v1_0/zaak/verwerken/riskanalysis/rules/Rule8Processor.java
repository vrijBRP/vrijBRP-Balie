 ...
 * Rule 8
 */
public class Rule8Processor extends AbstractDistrictRuleProcessor {

  public Rule8Processor() {
    super(RiskProfileRuleType.RULE_8);
  }
  ...
  public boolean process(DossierRiskAnalysis riskAnalysis,
    ...
    return isDistrictMatch(relatedCase, rule, "buurt", Container.BUURT);
  }
}
