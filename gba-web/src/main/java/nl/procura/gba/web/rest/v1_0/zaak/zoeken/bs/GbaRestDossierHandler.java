...
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.AANGEVER;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.AANGIFTE;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.AFGELEID_VAN;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.AFGEVER;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.AKTE_BRP_NUMMER;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.AKTE_JAAR;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.AKTE_NUMMER;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.AKTE_PLAATS;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.AMBTENAAR;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.ANR;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.AUTORITEIT;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.BETROKKENE;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.BRONDOCUMENT;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.BSN;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.BUITENLANDS_ID_NR;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.BURGERLIJKE_STAAT;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.DATUM_AKTE;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.DATUM_BURGERLIJKE_STAAT;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.DATUM_EINDE;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.DATUM_FEIT;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.DATUM_GEBOORTE;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.DATUM_INGANG;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.DATUM_ONTLENING;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.DATUM_TYPE;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.DATUM_VERKRIJGING;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.DATUM_VERLIES;
...
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.DOSSIER;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.EERDER_IN_NL_GEWOOND;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.ERKENNER;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.EX_PARTNER;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.GEBOORTE;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.GEMEENTE;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.GERELATEERDE_BRP;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.GERELATEERDE_NIET_BRP;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.GESLACHTSAANDUIDING;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.GESLACHTSNAAM;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.GETUIGE;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.HNR;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.HNR_A;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.HNR_L;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.HNR_T;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.INITIALEN;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.INSCHRIJVER;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.KIND;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.LAND;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.MEDE_VERZOEKER_KIND;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.MEDE_VERZOEKER_PARTNER;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.MOEDER;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.NAAMGEBRUIK;
...
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.ONBEKEND;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.OUDER;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.OVERLEDENE;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.PARTNER;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.PERSOON;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.PLAATS;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.POSTCODE;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.REDEN_VERKRIJGING_NL;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.REGISTERDEEL;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.REGISTERSOORT;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.REISDOCUMENT;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.REISDOCUMENTEN;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.SINDS;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.SOORT;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.STRAAT;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.TIJD_ONTLENING;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.TITEL_PREDIKAAT;
...
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.TYPE_VERKRIJGING;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.VADER_DUO_MOEDER;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.VERSTREKKINGSBEPERKING;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.VOLGNUMMER;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.VOORNAMEN;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.VOORVOEGSEL;
import static nl.procura.gba.web.rest.v1_0.algemeen.GbaRestElementType.WOONPLAATS;
import static nl.procura.gba.web.services.bs.algemeen.akte.DossierAkteRegistersoort.AKTE_ERKENNING_NAAMSKEUZE;
import static nl.procura.gba.web.services.bs.algemeen.akte.DossierAkteRegistersoort.AKTE_GEBOORTE;
...
import static nl.procura.gba.web.services.bs.algemeen.akte.DossierAkteRegistersoort.AKTE_OVERLIJDEN;
  ...
  protected GbaRestElement getSoort(DossierPersoonType dossierPersoonType) {
    ...
    switch (dossierPersoonType) {
      ...
      case GERELATEERDE_NIET_BRP:
        ...
        break;
      case MEDE_VERZOEKER_KIND:
        value = MEDE_VERZOEKER_KIND;
        break;
      case MEDE_VERZOEKER_PARTNER:
        value = MEDE_VERZOEKER_PARTNER;
        break;
      case ONBEKEND:
        value = ONBEKEND;
        break;
