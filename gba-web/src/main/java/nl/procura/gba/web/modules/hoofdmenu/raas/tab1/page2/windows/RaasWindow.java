...
public class RaasWindow extends GbaModalWindow {

  public RaasWindow(DocAanvraagDto aanvraag) {
    setWidth("70%");
    setCaption("Reisdocument aanvraag voor het RAAS");
    addComponent(new ModuleTemplate() {
      ...
      public void event(PageEvent event) {
        ...
        if (event.isEvent(InitPage.class)) {
          getPages().getNavigation().goToPage(new Tab1RaasMenuPage(aanvraag));
        }
      }
    });
  }
