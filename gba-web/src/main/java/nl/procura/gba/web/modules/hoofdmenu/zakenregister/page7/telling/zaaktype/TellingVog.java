...
public class TellingVog extends TellingTemplate {

  public static TypeVog get(ZaakType zaakType, Group<Zaak> group) {
    return new TypeVog(zaakType, group);
  }

  public static class TypeVog extends DashboardTellingType {

    public TypeVog() {
    }

    public TypeVog(ZaakType zaakType, Group<Zaak> group) {
