...
public class OnderzoekOverzichtBuilder {

  public static void addTab(ZaakTabsheet tabsheet, ZaakDossier zaakDossier) {

    DossierOnderzoek dossierOnderzoek = to(zaakDossier, DossierOnderzoek.class);
    tabsheet.addTab(new OnderzoekOverzichtLayout(dossierOnderzoek), "Onderzoek");
