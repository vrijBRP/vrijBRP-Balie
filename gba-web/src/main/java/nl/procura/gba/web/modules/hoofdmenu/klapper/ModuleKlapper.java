...
@ModuleAnnotation(url = "#bs.klapper",
    caption = "Klapper",
    profielActie = ProfielActie.SELECT_HOOFD_KLAPPER)
public class ModuleKlapper extends ModuleTemplate {

  public ModuleKlapper() {
  }
  ...
  public void event(PageEvent event) {
    ...
    if (event.isEvent(InitPage.class)) {
      ...
      getPages().getNavigation().goToPage(Page1Klapper.class);
    }
