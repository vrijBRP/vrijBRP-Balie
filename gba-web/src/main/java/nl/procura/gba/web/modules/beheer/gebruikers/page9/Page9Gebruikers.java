...
package nl.procura.gba.web.modules.beheer.gebruikers.page9;
...
public class Page9Gebruikers extends NormalPageTemplate {

  private final BeheerTabsheet tabs = new BeheerTabsheet();

  public Page9Gebruikers(List<Gebruiker> userList) {

    super("Locaties koppelen aan gebruikers");

    addButton(buttonPrev);

    final SelectedUsersPage usersTab = new SelectedUsersPage(userList, KoppelbaarAanGebruikerType.LOCATIE);
    final KoppelLocatiesAanGebruikers locTab = new KoppelLocatiesAanGebruikers(userList);
