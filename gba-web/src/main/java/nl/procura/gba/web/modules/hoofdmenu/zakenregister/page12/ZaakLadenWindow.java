...
public class ZaakLadenWindow extends VaadinTaskWindow {

  public ZaakLadenWindow(ZaakLadenTask task, VaadinTaskOptions options) {
    super(task, options);
    setCaption("Zaken worden geladen ...");
  }
}
