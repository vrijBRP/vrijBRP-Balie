...
public class OverlijdenBuitenlandOverzichtBuilder {

  public static void addTab(ZaakTabsheet tabsheet, ZaakDossier zaakDossier) {
    DossierOverlijdenBuitenland dossier = to(zaakDossier, DossierOverlijdenBuitenland.class);
    tabsheet.addTab(new OverlijdenBuitenlandOverzichtLayout(dossier), "Overlijden buitenland");
  }
}
