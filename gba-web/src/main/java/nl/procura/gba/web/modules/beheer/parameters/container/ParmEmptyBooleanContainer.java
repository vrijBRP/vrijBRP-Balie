...
public class ParmEmptyBooleanContainer extends IndexedContainer implements ProcuraContainer {

  public static final String OMSCHRIJVING = "Omschrijving";

  public ParmEmptyBooleanContainer() {
    addContainerProperty(OMSCHRIJVING, String.class, "");
    removeAllItems();

    Item item = addItem("");
    item.getItemProperty(OMSCHRIJVING).setValue("Leeg");
