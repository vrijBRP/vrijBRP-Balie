...
public class Tab3DocumentImportWindow extends GbaModalWindow {

  public Tab3DocumentImportWindow() {
    super("Importeren", "65%");
  }
  ...
  public void attach() {
    ...
    mainModule.getNavigation().addPage(new Tab3DocumentenImportPage1());
