...
package nl.procura.gba.web.modules.zaken.sms.page3;

import java.util.List;

import nl.procura.gba.web.modules.hoofdmenu.sms.page3.Page3SmsBean;
import nl.procura.gba.web.modules.hoofdmenu.sms.page3.Page3SmsForm;
...
public class Page3Sms extends PlPage {
  ...
  public void event(PageEvent event) {
    ...
    if (event.isEvent(InitPage.class)) {
      ...
      SmsService smsService = getServices().getSmsService();
      Customer customer = smsService.getCustomers().getCustomer();
      ...
      List<PlContactgegeven> contactgegevens = contactgegevensService.getContactgegevens(getPl());
      MobilePhoneNumber mobileNumber = contactgegevensService.getValidMobileNumber(contactgegevens);
      form = new Page3SmsForm(customer, bsn, mobileNumber);
      addComponent(form);
    }
