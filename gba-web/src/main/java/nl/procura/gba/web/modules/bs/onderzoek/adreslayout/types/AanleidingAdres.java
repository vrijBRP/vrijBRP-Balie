...
public class AanleidingAdres implements OnderzoekAdres {

  private final DossierOnderzoek onderzoek;

  public AanleidingAdres(DossierOnderzoek onderzoek) {
  ...
  public void setAdres(FieldValue adres) {
    onderzoek.setAanleidingAdres(adres);
  }
  ...
  public void setHnr(String hnr) {
    onderzoek.setAanleidingHnr(hnr);
  }
  ...
  public void setHnrL(String hnrL) {
    onderzoek.setAanleidingHnrL(hnrL);
  }
  ...
  public void setHnrA(FieldValue hnrA) {
    onderzoek.setAanleidingHnrA(hnrA);
  }
  ...
  public void setHnrT(String hnrT) {
    onderzoek.setAanleidingHnrT(hnrT);
  }
  ...
  public void setPlaats(FieldValue plaats) {
    onderzoek.setAanleidingPlaats(plaats);
  }
  ...
  public void setGemeente(FieldValue gemeente) {
    onderzoek.setAanleidingGemeente(gemeente);
  }
  ...
  public void setBuitenl1(String buitenl1) {
    onderzoek.setAanleidingBuitenl1(buitenl1);
  }
  ...
  public void setBuitenl2(String buitenl2) {
    onderzoek.setAanleidingBuitenl2(buitenl2);
  }
  ...
  public void setBuitenl3(String buitenl3) {
    onderzoek.setAanleidingBuitenl3(buitenl3);
  }
  ...
  public void setLand(FieldValue land) {
    onderzoek.setAanleidingLand(land);
  }

  @Override
  public void setGemeentePostbus(Gemeente gemeente) {
    onderzoek.setVermoedelijkeGemeentePostbus(gemeente);
  }

  @Override
  public FieldValue getAantalPersonen() {
    return onderzoek.getAanleidingAantalPersonen();
  }

  @Override
  public void setAantalPersonen(FieldValue aantalPersonen) {
    onderzoek.setAanleidingAantalPersonen(aantalPersonen);
  }
  ...
  public void setSource(AddressSourceType sourceType) {
    onderzoek.setAanleidingSource(sourceType);
  }
}
