...
package nl.procura.gba.web.modules.zaken.onderzoek;
...
public class ModuleOnderzoek extends ZakenModuleTemplate {
  ...
  public void event(PageEvent event) {
    ...
    if (event.isEvent(InitPage.class)) {
      getPages().getNavigation().goToPage(Page1Onderzoek.class);
    }
  }
}
