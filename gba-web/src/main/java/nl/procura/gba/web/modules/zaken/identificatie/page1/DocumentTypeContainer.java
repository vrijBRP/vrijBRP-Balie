...
public class DocumentTypeContainer extends GbaContainer {

  public DocumentTypeContainer() {
    addItem(IdentificatieType.PASPOORT);
    addItem(IdentificatieType.IDENTITEITSKAART);
    addItem(IdentificatieType.RIJBEWIJS);
    addItem(IdentificatieType.VERBLIJFSDOCUMENT);
  }
}
