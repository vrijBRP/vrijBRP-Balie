...
package nl.procura.gba.web.modules.beheer.kassa;

import nl.procura.gba.web.common.annotations.ModuleAnnotation;
import nl.procura.gba.web.components.layouts.ModuleTemplate;
import nl.procura.gba.web.modules.beheer.kassa.page1.Page1Kassa;
import nl.procura.gba.web.services.beheer.profiel.actie.ProfielActie;
import nl.procura.vaadin.component.layout.page.pageEvents.InitPage;
import nl.procura.vaadin.component.layout.page.pageEvents.PageEvent;

@ModuleAnnotation(url = "#beheer.kassa",
    caption = "Kassa",
    profielActie = ProfielActie.SELECT_BEHEER_KASSA)
