...
public class VolgendeMaand extends ZaakPeriode {

  public VolgendeMaand() {

    ProcuraDate d1 = new ProcuraDate().addMonths(+1);

    Calendar cal = Calendar.getInstance();
    cal.setTime(d1.getDateFormat());

    int max = (cal.getActualMaximum(Calendar.DATE) - 1);
    ...
    setDescr("Volgende maand (" + new DateFormatSymbols().getMonths()[cal.get(Calendar.MONTH)] + ")");
  }
}
