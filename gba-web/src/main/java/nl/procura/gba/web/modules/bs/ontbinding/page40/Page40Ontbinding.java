...
import static nl.procura.gba.web.modules.bs.ontbinding.page40.Page40OntbindingBean1.*;
...
public class Page40Ontbinding extends BsPage<DossierOntbinding> {

  private Page40OntbindingForm1 form1  = null;
  private Page40OntbindingTable table1 = null;

  public Page40Ontbinding() {

    super("Ontbinding/einde huwelijk/GPS in gemeente - naam(gebruik)");
  ...
  public boolean checkPage() {
    ...
    getZaakDossier().setTitelPartner1(FieldValue.from(form1.getBean().getTitelP1()));
    getZaakDossier().setTitelPartner2(FieldValue.from(form1.getBean().getTitelP2()));
    ...
    int i = 0;
    for (OntbindingNaamgebruik ng : table1.getAllValues(OntbindingNaamgebruik.class)) {
      i++;
      if (i == 1) {
  ...
  public void event(PageEvent event) {
    ...
    try {
      ...
      if (event.isEvent(InitPage.class)) {
        ...
        setInfo(
            "Bepaal of de namen van de partner wijzigen als gevolg van ontbinding/einde van de verbintenis en/of leg vast wat het gewenste naamgebruik moet gaan worden na ontbinding/einde. "
                + "<br/>Druk indien nodig in het afdrukscherm de verzoeken af voor ondertekening. Druk op Volgende (F2) om verder te gaan.");

        DossierOntbinding zd = getZaakDossier();
        DossierPersoon p1 = zd.getPartner1();
        DossierPersoon p2 = zd.getPartner2();

        Page40OntbindingBean1 bean = new Page40OntbindingBean1(p1, p2);
        ...
        addComponent(form1);
        addComponent(new Fieldset("Naamgebruik na ontbinding/einde verbintenis", table1));
      }
    } finally {
      super.event(event);
    }
  ...
  public class Form1 extends Page40OntbindingForm1 {

    private Form1(Page40OntbindingBean1 bean) {
      super(bean);
    }
  ...
  public class Table1 extends Page40OntbindingTable {
    ...
    public void set() {
      ...
      OntbindingNaamgebruik n1 = new OntbindingNaamgebruik();
      ...
      OntbindingNaamgebruik n2 = new OntbindingNaamgebruik();
