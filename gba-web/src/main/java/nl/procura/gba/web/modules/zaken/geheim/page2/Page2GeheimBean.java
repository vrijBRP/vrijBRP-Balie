...
public class Page2GeheimBean implements Serializable {
  ...
  @Field(caption = "Wijzigen in",
      type = Field.FieldType.LABEL)
  private String wijzigenIn = "&lt;Selecteer de nieuwe beperking in de tabel hieronder&gt;";
}
