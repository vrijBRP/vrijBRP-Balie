...
public class NaamgebruikWijzigingServiceTest extends ZaakServiceTest {
  ...
  public Zaak getNieuweZaak() {
    ...
    String zaakId = getNewZaakId(ZaakType.NAAMGEBRUIK);

    // Nieuwe zaak maken
    final NaamgebruikWijzigingService service = services.getNaamgebruikWijzigingService();
    final NaamgebruikAanvraag zaak = (NaamgebruikAanvraag) service.getNewZaak();
