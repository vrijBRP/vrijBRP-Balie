...
public class VoorbeeldRdwClient {

  private final static Logger LOGGER = LoggerFactory.getLogger(VoorbeeldRdwClient.class.getName());

  public VoorbeeldRdwClient() throws FileNotFoundException {

    Proces returnProces = RdwClient.send("https://<ip>/start.rdw",
