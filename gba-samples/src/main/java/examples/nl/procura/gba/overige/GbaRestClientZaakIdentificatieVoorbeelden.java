...
public class GbaRestClientZaakIdentificatieVoorbeelden extends GbaRestClientVoorbeelden {

  public GbaRestClientZaakIdentificatieVoorbeelden() throws GbaRestClientException {
    identificatieToevoegen();
  }

  public static void main(String[] args) {
    GbaRestGuice.getInstance(GbaRestClientZaakIdentificatieVoorbeelden.class);
  }

  @Timer
  protected void identificatieToevoegen() throws GbaRestClientException {
