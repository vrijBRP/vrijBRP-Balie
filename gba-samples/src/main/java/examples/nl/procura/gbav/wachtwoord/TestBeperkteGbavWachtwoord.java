...
public class TestBeperkteGbavWachtwoord {

  private final static Logger LOGGER = LoggerFactory.getLogger(TestBeperkteGbavWachtwoord.class.getName());

  public TestBeperkteGbavWachtwoord() {
    ...
    try {
      ...
      GbavAntwoord antwoord = actie.wijzig("1234");
  ...
  public static void main(String[] args) {
    ...
    new TestBeperkteGbavWachtwoord();
  }
