...
public class GbaWsRestGuice {

  private final static Logger   LOGGER         = LoggerFactory.getLogger(GbaWsRestGuice.class.getName());
  ...
  public static class GuiceModule extends AbstractModule {
    ...
    protected void configure() {
      ...
      Matcher<Class> matchers = Matchers.subclassesOf(GbaWsRestClientVoorbeelden.class);
