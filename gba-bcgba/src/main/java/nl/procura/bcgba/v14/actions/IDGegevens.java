...
public class IDGegevens {
  ...
  /**
   * @param voorvoegselGeslachtsnaam the voorvoegselGeslachtsnaam to set
   */
  ...
  /**
   * @param geboorteland the geboorteland to set
   */
  ...
  /**
   * @param nationaliteit the nationaliteit to set
   */
  ...
  /**
   * @param buitenlandsPersoonsnummer
   */
