...
import nl.bprbzk.gba.lo3.version1.*;
...
public class BeperkteGbavAntwoordConverter extends GbavAntwoordConverter {

  public static void convert(nl.bprbzk.gba.lrdplus.version1.Resultaat gbavResultaat, GbavResultaat resultaat) {
  ...
  public static void convert(Antwoord gbavAntwoord, GbavVraagAntwoord vraagAntwoord,
      BasePLBuilder plBuilder) {
    vraagAntwoord.setBasisPLHandler(plBuilder);
    convert(gbavAntwoord.getResultaat(), vraagAntwoord.getResultaat());
    convert(gbavAntwoord, plBuilder);
  }

  private static void convert(Antwoord gbavAntwoord, BasePLBuilder plBuilder) {
